...
const showOnlyForAdministrationManagementCustomApiCall = {
	operation: ['customApiCall'],
	resource: ['Administration Management'],
};

export const administrationManagementCustomApiCallDescription: INodeProperties[] = [
	{
		displayName: 'HTTP Method',
		name: 'method',
		type: 'options',
		displayOptions: {
			show: showOnlyForAdministrationManagementCustomApiCall,
		},
		options: [
